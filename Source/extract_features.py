...
def get_feature_extractor(device):
    ...
    Lớp phân loại (fully connected layer) cuối cùng được gỡ bỏ vì ta chỉ cần lấy vector đặc trưng.
...
if __name__ == "__main__":
    # Lấy thư mục chứa file extract_features.py hiện tại (chính là thư mục Source)
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    
    # Tự động nối chuỗi đường dẫn chính xác 100%
